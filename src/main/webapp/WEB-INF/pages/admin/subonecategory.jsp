...
<aside class="right-side">
	...
	<section class="content-header">
		<h1>
			...
			<i class="fa fa-tasks" aria-hidden="true"></i><small>Sub One Category</small>
		</h1>
		<ol class="breadcrumb">
...
<script src="${pageContext.request.contextPath}/resources/static/angular-app/add_sub_one_category_app.js"></script>
